...
const (
	...
	GreetService_SayHelloBirectionalStreaming_FullMethodName = "/greet_service.GreetService/SayHelloBirectionalStreaming"
)
...
type GreetServiceClient interface {
	...
	SayHelloBirectionalStreaming(ctx context.Context, opts ...grpc.CallOption) (GreetService_SayHelloBirectionalStreamingClient, error)
}
...
func (c *greetServiceClient) SayHelloBirectionalStreaming(ctx context.Context, opts ...grpc.CallOption) (GreetService_SayHelloBirectionalStreamingClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[2], GreetService_SayHelloBirectionalStreaming_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &greetServiceSayHelloBirectionalStreamingClient{ClientStream: stream}
	return x, nil
}

type GreetService_SayHelloBirectionalStreamingClient interface {
	Send(*HelloRequest) error
	Recv() (*HelloResponse, error)
	grpc.ClientStream
}

type greetServiceSayHelloBirectionalStreamingClient struct {
	grpc.ClientStream
}

func (x *greetServiceSayHelloBirectionalStreamingClient) Send(m *HelloRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceSayHelloBirectionalStreamingClient) Recv() (*HelloResponse, error) {
	m := new(HelloResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type GreetServiceServer interface {
	...
	SayHelloBirectionalStreaming(GreetService_SayHelloBirectionalStreamingServer) error
...
func (UnimplementedGreetServiceServer) SayHelloBirectionalStreaming(GreetService_SayHelloBirectionalStreamingServer) error {
	return status.Errorf(codes.Unimplemented, "method SayHelloBirectionalStreaming not implemented")
}
...
func _GreetService_SayHelloBirectionalStreaming_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).SayHelloBirectionalStreaming(&greetServiceSayHelloBirectionalStreamingServer{ServerStream: stream})
}

type GreetService_SayHelloBirectionalStreamingServer interface {
	Send(*HelloResponse) error
	Recv() (*HelloRequest, error)
	grpc.ServerStream
}

type greetServiceSayHelloBirectionalStreamingServer struct {
	grpc.ServerStream
}

func (x *greetServiceSayHelloBirectionalStreamingServer) Send(m *HelloResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceSayHelloBirectionalStreamingServer) Recv() (*HelloRequest, error) {
	m := new(HelloRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "SayHelloBirectionalStreaming",
			Handler:       _GreetService_SayHelloBirectionalStreaming_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
